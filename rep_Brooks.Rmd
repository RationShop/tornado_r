...
Check the KDE weights - make sure they add up to 1.
...
```{r}
# some plots for June 1
range(space_raw[,,153])
range(space_smooth[,,153])
plot(raster(space_raw[,,153]))
plot(raster(space_smooth[,,153]))
```
